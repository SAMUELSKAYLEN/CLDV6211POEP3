...
namespace ST10443307CLVDProjectPOEPart3.Controllers
{
    public class VenueController : Controller
    {
        ...
        {
            var connectionString = "DefaultEndpointsProtocol=https;AccountName=cldvpoe2blob;AccountKey=BKfetNb4rHgub3af4sBjgYFvPeZxiB0MaJFU+FMVmdGt+MuuH7NUFQhhpn3wzrdf1jjWhqKnUHxG+AStSKdJDA==;EndpointSuffix=core.windows.net";
